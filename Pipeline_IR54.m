...
%     {'IR41',{'2016051011_0001.besa'}},...% potential second block!
%     {'IR48',{'2016092915_0028.besa'}},...
%     {'IR54',{'2017012411_0008.besa'}},...
%     {'IR52',{'2017010513_0022.besa'}}...
%     {'IR57',{'2017032319_0023.besa'}}...


SBJ      = 'IR54';
raw_file = '2017012411_0008.besa';
...
preproc_vars.ch_lab.probes = {'RAM','RHH','RTH','RAC','ROF','LAM','LHH','LTH','LAC','LOF'};
preproc_vars.ch_lab.ROI    = {'RAC*','ROF*','LAC*','LOF*'};
...
bsln_times = {...
    [0.0 18.0],...% initial offset (attaching to screen?% first 4 trials are missing photodiode; onset of 5th is messed up (toss all 5)
    [117.0 119.0]...% extra blip of a trial at the end of B1
    };
