function SBJ07a_ERP_diff_actv(SBJ,pipeline_id,an_id)
% Calculates ERPs within condition and takes the difference
% before comparing against a null distribution generated by circular shifts
% clear all; %close all;
rng('shuffle'); % seed randi with time
error('didnt write this script, doesnt work yet)');
%% Data Preparation
