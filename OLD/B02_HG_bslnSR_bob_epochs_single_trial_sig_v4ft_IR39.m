...
ch_ids   = {{'RAC*','ROF*','RIN*','LOF*','LIN*','RAM7-RAM8'}};%{'RAM*','RIN*','RAC*','LOF*','ROF*'}};
...
%             end
        ...
        sig_ts = logical(sig_pvals(ch_ix,:)<0.05);
    ...
    save(sig_times_file,'sig_times','sig_wins','sig_pvals','ch_ids','header_ecog');
