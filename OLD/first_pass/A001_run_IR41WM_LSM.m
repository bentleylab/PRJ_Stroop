function A001_run_IR21WM_RC(no_interaction)
...
preproc_filename = strcat('/home/knight/hoycw/PRJ_Stroop/data/IR41/02_preproc/',preproc_file);
...
ft_line_noise_freqs = [60 120 180 240 300];
cfg = [];
cfg.dftfilter = 'yes';
...
% photo_channel_n = 1;
yval = 5000;
set_times = [0.0 161.0 261.0 421.0 751.0 757.0];
...
log_dir_struct.log_file_str = 'IR41_strooptask_log.txt';
log_dir_struct.wav_file_dir = 'IR41_strooptask_wavfiles';
ignore_trials = [];
