function A01_import_reref_filter_ft_besa_limits(data_id, data_file_str, save_file_str, analysis_channels, event_channels, varargin)
% CWH Edits:
...
if(~isempty(analysis_time{1}))
    ...
    for time_grp = 1:length(analysis_time)
        all_analysis_points_ecog = [all_analysis_points_ecog ...
            analysis_points{time_grp}(1):analysis_points{time_grp}(2)];
