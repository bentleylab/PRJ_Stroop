...
an.trial_lim_s = [-1.625 1.625];        % window in SEC for cutting trials
an.bsln_evnt   = 'stim';
an.bsln_type   = 'zboot';
an.bsln_boots  = 1000;
an.bsln_lim    = [-1.5 -1.5];    % window in SEC for baseline correction
an.demean_yn   = 'no';
...
cfg_tfr.foi          = an.foi_center;  % analysis 2 to 128 Hz, log spaced
cfg_tfr.toi          = 'all';
