...
%% Plot ERPs
fig_dir  = strcat('/home/knight/hoycw/PRJ_Stroop/results/multifreq/GRP/',cond_name,'/',analysis,'/',event,'/');
if ~exist(fig_dir,'dir')
    mkdir(fig_dir);
end

% Plot Condition ERPs
fig_file = ['GRP_' analysis '_' strjoin(plot_rois,'.') '_'...
