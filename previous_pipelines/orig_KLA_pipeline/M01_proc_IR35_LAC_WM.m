...
line_noise_freqs = [60 100 120 180 200 240 300];%[60 180 300 were visible, but using 60 120 to reproduce KLA decisions...];
...
% 9 blocks, The photodiode data between Block 1 and Block 2 is bad
