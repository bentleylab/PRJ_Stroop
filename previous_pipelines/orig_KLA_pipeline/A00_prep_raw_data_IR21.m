...
event_channels = [1 4]; % From all imported channels
...
analysis_time = {[65 1375]}; %not sure about excluding the freeze, which is ~45s

% Focusing on RC1-4, which are GM 
% RC5, 6 are WM refs from KLA, but 5 is actually on the boudnary in the
% final recon; RC6,7 and perhaps 8 would be good for second pass
possible_data_lab = {'RC1', 'RC2', 'RC3', 'RC4'};
possible_refs_lab = {'RC5', 'RC6'}; 
...
reref_channels = {[21 25 26], [22 25 26], [23 25 26], [24 25 26]};
