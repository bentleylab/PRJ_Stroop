%% Prepare raw data fro preprocessing
...
SBJ = 'IR35';%input('Enter subject ID:  ','s');
raw_file = '2016021711_0006.besa';
raw_data_id = 'IR35_LAC';
...
% events start ~116 and end ~1129; 9 blocks
analysis_time = {[105 1140]};

% Focusing on LAC (good aMCC)
%   LAC1-4 are all good GM, LAC3 looks like great aMCC
%   LAC5 is good WM ref, LAC6 is possible but starting to get a hint of LPFC GM
possible_data_lab = {'LAC1', 'LAC2', 'LAC3', 'LAC4'};
possible_refs_lab = {'LAC5'};%, 'LAC6'}; % can potentially go back and use LAC6 too
