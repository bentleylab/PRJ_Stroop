...
SBJ = 'IR31';%input('Enter subject ID:  ','s');
raw_file = '2015111117_0005.besa';
...
% events start immediately ~6.5s (problem for filtering!) and end ~898; 8 blocks
analysis_time = {[0 910]};
...
possible_data_lab = {'LAC1', 'LAC2'};
possible_refs_lab = {'LAC3'};
