...
% Small hump at 60, then maybe 180, definitely 300 Hz
line_noise_freqs = [60 120];%[60 180 300 were visible, but using 60 120 to reproduce KLA decisions...];
...
% photo_channel_n = 1;
yval = 18000; %this is the zero/baseline during a block
set_times = [0.0 11.0 102.0 160.0]; % in sec
...
ignore_trials = [25 26]; % exclude 25 and 26 for the distruption at the start of B2
