...
SBJ_files = {...
    {'IR48',{'2016092915_0021.besa','2016092915_0022.besa','2016092915_0023.besa','2016092915_0024.besa'}},...%
...
for SBJ_ix = 1:length(SBJ_files)
    ...
    SBJ_dir = fullfile('/home/knight/hoycw/Data_Extraction/data/',SBJ);
    ...
    for file_ix = 1:length(SBJ_files{SBJ_ix}{2});
        ...
        %% Load the data
        preclean_filename = strcat(out_dir,SBJ,'_preclean_B',num2str(file_ix),'.mat');
        ...
        elseif strcmp(raw_filename(end-4:end),'.besa')
            cfg = [];
        ...
        if plot_it == 1
            out_filename = strcat(out_dir,SBJ,'_bob_clean_B',num2str(file_ix),'.mat');
        else
            out_filename = strcat(out_dir,SBJ,'_preclean_B',num2str(file_ix),'.mat');
        end
        fprintf('============== Saving %s ==============\n',out_filename);
