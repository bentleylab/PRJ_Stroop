function SBJ02_behav_parse(SBJ, rt_window, ignore_trials, plot_it, save_it)
%
...
evnt_filename = [SBJ_dir '02_preproc/' SBJ '_evnt_clean.mat'];
preproc_vars_filename = [SBJ_dir '01_import/' SBJ '_preproc_vars.mat'];
log_filename = [SBJ_dir '00_raw/' SBJ '_strooptask_log.txt'];
wav_dir = [SBJ_dir '00_raw/' SBJ '_strooptask_wavfiles/'];
%   create directory if needed
output_dir = [SBJ_dir '03_events/'];
...
nrl_srate = preproc_vars.resamp_freq;
...
trial_info.sample_rate = nrl_srate;
