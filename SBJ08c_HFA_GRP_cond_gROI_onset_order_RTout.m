function SBJ08c_HFA_GRP_cond_gROI_onset_order_RTout(SBJs,conditions,pipeline_id,an_id,plt_id,save_fig,fig_vis)
...
for sbj_ix = 1:numel(SBJs)
    ...
    line([plt_vars.plt_lim(1) plt_vars.plt_lim(2)],[SBJ_ys(sbj_ix) SBJ_ys(sbj_ix)],'Color',[0.2 0.2 0.2],'LineStyle',':');
end
