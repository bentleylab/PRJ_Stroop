...
if isstr(filename)
   ...
   if isfield(eloc, 'sph_theta_besa')
       ...
       catch, disp('Warning: coordinate conversion failed 1'); end;
   ...
   elseif isfield(eloc, 'sph_theta')
       ...
       catch, disp('Warning: coordinate conversion failed 2'); end;
   elseif isfield(eloc, 'X')
       try
           eloc = convertlocs(eloc, 'cart2all');  
       catch, disp('Warning: coordinate conversion failed 3'); end;
   else 
       try
           eloc = convertlocs(eloc, 'topo2all');  
       catch, disp('Warning: coordinate conversion failed 4'); end;
   end;
