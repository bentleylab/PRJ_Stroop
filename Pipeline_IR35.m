...
preproc_vars.ch_lab.probes = {'RAM','RHH','RTH','RIN','ROF','LAM','LHH','LTH','LAC','LOF','LIN','LPC'};
preproc_vars.ch_lab.ROI    = {'RIN*','ROF*','LAC*','LOF*','LIN*'};
...
preproc_vars.ch_lab.eeg = {};
preproc_vars.ch_lab.photod = {'DC01'};
preproc_vars.ch_lab.mic    = {'DC02'};
...
preproc_vars.notch_freqs = [60 120 180 240 300]; %100, 200 shoudl come out in re-referencing
preproc_vars.bs_width    = 2;

%--------------------------------------
% Time Parameters
%--------------------------------------
preproc_vars.analysis_time = {[105 1140]};
...
bsln_times = {...
    [0.0 11.5],...% initial offset (attaching to screen?% first 4 trials are missing photodiode; onset of 5th is messed up (toss all 5)
