...
SBJs = {'IR21','IR27','IR31','IR32','IR35','IR37','IR39','IR41','IR48','IR52','IR54','IR57','IR61','IR65','IR68','IR72','IR74'};
SBJ = 'IR37';
pipeline_id = 'main_ft';
actv_win    = '100';
save_fig    = 1;
...
% Single SBJ
B00_RT_SBJ_hist(SBJ,save_fig,fig_vis,fig_type);
B00_RT_SBJ_sequence_plots(SBJ,save_fig,fig_vis,fig_type);

% Group
B00_RT_GRP_hist_norm(SBJs,'CNI',save_fig,fig_vis);
B00_RT_GRP_hist(SBJs,'CNI',save_fig,fig_vis);

%% Plot HFA activations
