...
% %     proc_id,actv_win,plt_id,save_fig,fig_vis,fig_ftype)
% % 
...
% % SBJ08b_HFA_plot_SR_stats_svg('IR57','LAC5-6',conditions,proc_id,...
% %     an_id_s,an_id_r,plt_id,save_fig,fig_vis);
% % % SBJ08b_HFA_plot_SR_stats_svg('IR72','LPC2-3',conditions,proc_id,...
% % %     an_id_s,an_id_r,plt_id,save_fig,fig_vis);
% % % SBJ08b_HFA_plot_SR_stats_svg('IR74','LIN1-2',conditions,proc_id,...
% % %     an_id_s,an_id_r,plt_id,save_fig,fig_vis);
% 
...
% %             % Violin Plots
%             SBJ10c_HFA_GRPavg_onsets_ROI_normRTout_RT_ANOVA(SBJs,stat_id,proc_id,an_opts{an_ix},roi_opts{roi_ix},...
