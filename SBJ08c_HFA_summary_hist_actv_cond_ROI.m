function SBJ08c_HFA_summary_hist_actv_cond_ROI(SBJ,conditions,pipeline_id,an_id,actv_win,plt_id,save_fig,fig_vis)
...
fig_name = [SBJ '_HFA_ROI_hist_onset_actv_cond_ROI_' event];
...
% Create and format the plot
fig_name = [SBJ '_HFA_ROI_hist_onset_actv_cond_gROI_' event];
figure('Name',fig_name,'units','normalized',...
        'outerposition',[0 0 1 1],'Visible',fig_vis);
