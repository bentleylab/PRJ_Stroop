function A00_run_S04IR26WM(no_interaction)
...
subject_id = 'S04IR26WM';
file_name = '2015082020_0002.edf';
...
if(~no_interaction)
    ...
    % LCI(LPC) Might be in cingulate. First 8 electrodes are very noisy and
    % might be microelectrodes not connected. Last 8 look okay.
...
data_times = {[20 805],[910 1136]}; % In seconds. Leave at least 10 seconds on edge for edge artifacts
