function A01_import_reref_filter(subject_id, data_file_str, save_file_str, analysis_channels, event_channels, varargin)
...
if(~isempty(line_noise_freqs))
  ...
  data_ecog2 = cleanline2(data_ecog, header_ecog.sample_rate, ...
    'LineFrequencies',  line_noise_freqs, ...
    'ScanForLines',     1, ...
    'LineAlpha',        0.01, ...
    'Bandwidth',        3, ...
    'ChanCompIndices',  1:header_ecog.n_channels, ...
    'SlidingWinLength', 4.0, ...
    'SlidingWinStep',   3.0, ...
    'SmoothingFactor',  100, ...
    'PaddingFactor',    1, ...
    'ComputeSpectralPower', 0, ...
    'PlotFigures', 1, ...
    'VerboseOutput',    0);
