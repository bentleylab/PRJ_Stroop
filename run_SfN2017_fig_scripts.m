...
an_id       = 'HGm_R_zbtS_trl5to1_sm10_wn30_stat5to1';
% submit: SBJ10a_ANOVA_regressRT(SBJ,an_id,stat_id)

%% Plot ANOVA
an_id_s = 'HGm_S_zbtS_trl2to15_sm10_wn30_stat15';
an_id_r = 'HGm_R_zbtS_trl5to1_sm10_wn30_stat5to1';
plt_id  = 'ts_S0to15_R5to10_errbr_evnt_scat';
for sbj_ix = 1:numel(SBJs)-1
    SBJ10b_ANOVA_plot_SR(SBJs{sbj_ix},stat_id,an_id_s,an_id_r,plt_id,1,'off');
end
...
for sbj_ix = 1:numel(SBJs)
    ...
    SBJ10b_ANOVAfdr_plot_SR_RTcorr(SBJs{sbj_ix},stat_id,an_id_s,an_id_r,plt_id,1,'off');
    close all;
end
...
SBJ10c_HFA_GRP_ANOVA_ROI_onsets_RTout(SBJs,stat_id,pipeline_id,an_id,roi_id,plt_id,1,'on')

an_id       = 'HGm_R_zbtS_trl5to1_sm10_wn30_stat5to1';
SBJ10c_HFA_GRP_ANOVA_ROI_onsets_RTout(SBJs,stat_id,pipeline_id,an_id,roi_id,plt_id,1,'on')

%% Proportions of significant effects across ROI
an_list     = {'HGm_S_zbtS_trl2to15_sm10_wn30_stat15','HGm_R_zbtS_trl5to1_sm10_wn30_stat5to1'};
plt_id      = 'onsets_trl0to15_evnt_roi';
...
for roi_ix = 1:numel(roi_list)
    for an_ix = 1:numel(an_list)
        SBJ10c_HFA_GRP_summary_bar_perc_actv_RT_ANOVA_ROI(SBJs,stat_id,pipeline_id,...
            an_list{an_ix},actv_win,roi_list{roi_ix},plt_id,save_fig,fig_vis);
    end
end
