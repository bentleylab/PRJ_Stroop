...
% Analysis Parameters
SBJs       = {'IR39'};%'IR21','IR31','IR32','IR35','IR39'};%'IR39'};%};%
ch_ids     = {{'RAC*','ROF*','RIN*','LOF*','LIN*','RAM7-RAM8'}};%,'LAC2-LAC3'}};%{'RC_WM'},{'LAC_WM'},{'IH_CA'},{'LAC_WM'},{'RAC_WM'}};%,'RAC_BP_data'}};%{'RAC_WM'}};
...
plot_lim      = [2000 2000];            % ms to plot before the event and **after RT**
