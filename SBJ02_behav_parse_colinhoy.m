function SBJ02_behav_parse_colinhoy(SBJ, rt_window, ignore_trials, plot_it, save_it)
%
...
%% File paths
SBJ_vars_cmd = ['run /Volumes/hoycw_clust/PRJ_Stroop/scripts/SBJ_vars/' SBJ '_vars.m'];
eval(SBJ_vars_cmd);

helper_function_dir_name = '/Volumes/hoycw_clust/PRJ_Stroop/scripts/utils/';
